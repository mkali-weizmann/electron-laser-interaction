...
aberration_propagator = AberrationsPropagator(Cs=1e-8, defocus=10e-9, astigmatism_parameter=0,
                                              astigmatism_orientation=0)

M = Microscope([dummy_sample, first_lens, cavity_2f_analytical, second_lens, aberration_propagator],
               print_progress=True,
